...
class Board:
    def __init__(self, window):
        ...
        self.pieces = [
            # Computer
            Piece(self.window, 0, 0, False), Piece(self.window, 0, 2, False),
            Piece(self.window, 0, 4, False), Piece(self.window, 0, 6, False),
            Piece(self.window, 1, 1, False), Piece(self.window, 1, 3, False),
            Piece(self.window, 1, 5, False), Piece(self.window, 1, 7, False),
            Piece(self.window, 2, 0, False), Piece(self.window, 2, 2, False),
            Piece(self.window, 2, 4, False), Piece(self.window, 2, 6, False),
            # Player
            Piece(self.window, 5, 7, True), Piece(self.window, 5, 5, True),
            Piece(self.window, 5, 3, True), Piece(self.window, 5, 1, True),
            Piece(self.window, 6, 6, True), Piece(self.window, 6, 4, True),
            Piece(self.window, 6, 2, True), Piece(self.window, 6, 0, True),
            Piece(self.window, 7, 7, True), Piece(self.window, 7, 5, True),
            Piece(self.window, 7, 3, True), Piece(self.window, 7, 1, True)
        ]
